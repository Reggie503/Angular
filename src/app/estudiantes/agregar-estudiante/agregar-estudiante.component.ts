...
import * as estudianteInterface from '../../interfaces/estudiante.interface';
...
export class AgregarEstudianteComponent implements OnInit {
  ...
  formEstudiante: estudianteInterface.Estudiante;
  ...
  constructor() {
    ...
    this.formEstudiante = {} as estudianteInterface.Estudiante;
